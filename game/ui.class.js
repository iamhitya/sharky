...
export default class UI {
    ...
    showWinContainer() {
        ...
        gsap.fromTo(document.getElementById('win-sharky'), { y: this.game.canvas.height / 2 }, { y: 0, duration: 0.4, delay: 2, ease: Power1.easeOut });
    ...
    updateHealthbar() {
        ...
        this.healthbar.style.background = this.getHealthbarGradient(character.health);
    };
    ...
    updateBossHealthbar() {
        ...
        /**set color gradient */
        this.bossHealthbar.style.background = this.getHealthbarGradient(boss.health);
    ...
    getHealthbarGradient(health) {
        if (health > 50) {
            return 'linear-gradient(#b5ff2b, #82c900)';
        } else if (health > 30) {
            return 'linear-gradient(#FFE47C, #FFCF00)';
        }

        return 'linear-gradient(#FF9C75, #FF4B00)';
    };
