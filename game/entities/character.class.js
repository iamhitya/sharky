...
export default class Character extends MovableObject {
  ...
  SWIM_ANIMATION = {
    frames: 5,
    path: "./assets/sharky/swim/",
    loop: true,
  };

  IDLE_ANIMATION = {
    frames: 18,
    path: "./assets/sharky/idle/",
    loop: true,
  };

  SLAP_ANIMATION = {
    frames: 3,
    path: "./assets/sharky/attack/fin-slap/",
    loop: false,
  };

  BUBBLE_ANIMATION = {
    frames: 4,
    path: "./assets/sharky/attack/bubble-tap/",
    loop: false,
  };

  NORMAL_HURT_ANIMATION = {
    frames: 1,
    path: "./assets/sharky/hurt/",
    loop: false,
  };

  ELECTRIC_HURT_ANIMATION = {
    frames: 2,
    path: "./assets/sharky/hurt/electric/",
    loop: false,
  };

  POISON_HURT_ANIMATION = {
    frames: 5,
    path: "./assets/sharky/hurt/poison/",
    loop: false,
  };

  DEATH_ANIMATION = {
    frames: 8,
    path: "./assets/sharky/dead/",
    loop: false,
  };
  ...
  /**load assets */
  load() {
    this.loadImage("./assets/sharky/swim/1.png");
  ...
  becomeInvincible() {
    ...
    setTimeout(() => {
      if (!this.isDead) {
        ...
        this.resumeSwimOrIdleAnimation();
      }
    }, 1000);
  }

  resumeSwimOrIdleAnimation() {
    if (this.isSwimming) {
  ...
  die() {
    ...
    this.game.sounds.playSound("./assets/sounds/small-hit.wav");
    setTimeout(() => {
      this.loadImage("./assets/sharky/dead/7.png");
    }, 1050);
  ...
  updateSwim() {
    ...
    /**update sharky position and camera target  if possible*/
    if (
      this.right &&
      !this.barrierRight &&
